...
function RestaurantsList({ lat, long }: Props) {
	...
	const { data: restaurants, isLoading } = trpc.useQuery(["restaurants.getRestaurantsNearCoordinates", { lat, long }], {
		enabled: !!lat && !!long,
		staleTime: Infinity,
		cacheTime: Infinity,
	});
	...
	return (
		<div className="w-full flex flex-col space-y-12">
			...
			{restaurants &&
				...
				restaurants.map(({ name, photo, placeId, rating, userRatingsTotal, vicinity, lat, long }) => (
