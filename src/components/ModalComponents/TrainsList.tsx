...
import { RiTrainFill, RiTrainLine } from "react-icons/ri";
...
export default function TrainsList({ lat, long }: Props) {
          ...
          (
            ...
            >
              ...
              <div className="flex items-center space-x-5">
                <img
                  src={
                    "https://scontent.fbne3-1.fna.fbcdn.net/v/t1.6435-9/199805469_165472318943534_8271607149847551181_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=RqLwFebR9YMAX-OYj7M&_nc_ht=scontent.fbne3-1.fna&oh=00_AfAU32cInC3AWoH7k5pePt8SVzULw__rBUxYrZr8xspZUQ&oe=6430029B"
                  }
                  alt={"Qantas"}
                  className="h-8 w-8 bg-gray-200 object-cover rounded-full"
                />
                <p className="font-bold text-xl">Queensland Rail</p>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="w-3/5 space-y-3 text-gray-400 text-lg">
                  <div className="flex justify-between">
                    <RiTrainLine />
                    <p>On the way: {secondsToDhm(duration * 60)}</p>
                    <RiTrainFill />
                  </div>
                  <div>
